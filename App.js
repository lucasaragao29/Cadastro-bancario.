...
import {
  ...
  constructor(props){
    ...
    this.state = {
      ...
      sexos: [
        ...
        {sexoNome: 'Não-Binario', valor:3},
        {sexoNome: 'intersexo', valor:4},
      ],
      limite: 50,
      estudante: false,
    };
  ...
  render(){
    ...
    return(
      ...
      <Text style={styles.bancoLogo}>Laddis.Cop</Text>
      ...
      <View style={styles.areaFormulario}>
        ...
        <TouchableOpacity style={styles.botao} onPress={this.enviarDados} underlayColor="#000000">
            <Text style={styles.botaoTexto}>Enivar Dados</Text>
        </TouchableOpacity>
